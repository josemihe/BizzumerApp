        ...
        Column(
            ...
            Button(
                onClick = {
                    ...
                    val call = apiService.createGroup(token, nameState.value.text, commentState.value.text)
                    call.enqueue(object : Callback<MessageResponse> {
                        override fun onResponse(
                            ...
                            if (response.isSuccessful) {
                                ...
                                val toast = Toast.makeText(context, "Couldn't create the group", Toast.LENGTH_SHORT)
                                toast.show()
                            }
                        }
                ...
                Text(text = "Create Group", style = MaterialTheme.typography.h5)
            }
        }
    }
}